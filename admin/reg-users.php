...
{				?>	
										<tr>
											...
											<td><?php echo htmlentities($result->c_contact);?></td>
	                                        <td><?php echo htmlentities($result->c_dob);?></td>
											<td><?php echo htmlentities($result->c_address);?></td>
											<td><?php echo htmlentities($result->c_city);?></td>
											<td><?php echo htmlentities($result->c_country);?></td>
											<td><?php echo htmlentities($result->c_regdate);?></td>
										</tr>
										<?php $cnt=$cnt+1; }} ?>
