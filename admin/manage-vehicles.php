...
<?php $sql = "SELECT vehicles.VehiclesTitle,brands.brand_name,vehicles.PricePerDay,vehicles.FuelType,vehicles.ModelYear,vehicles.id from vehicles join brands on brands.id=vehicles.VehiclesBrand";
$query = $dbh -> prepare($sql);
$query->execute();
