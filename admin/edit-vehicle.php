			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Edit Car Information</h2>
...
<?php 
$id=intval($_GET['id']);
$sql ="SELECT vehicles.*,brands.brand_name,brands.id as bid from vehicles join brands on brands.id=vehicles.VehiclesBrand where vehicles.id=:id";
$query = $dbh -> prepare($sql);
$query-> bindParam(':id', $id, PDO::PARAM_STR);
$query->execute();
...
<?php $ret="select id,brand_name from brands";
